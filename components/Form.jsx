  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
        ...
        <form className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism" onSubmit={handleSubmit} >
            <label htmlFor="prompt" className="font-satoshi font-semibold text-base text-gray-700">Your AI Prompt</label>
            <textarea 
                value={post.prompt}
            ...
            />
            <label htmlFor="tag" className="font-satoshi font-semibold text-base text-gray-700">Tag {`{#tag}`}</label>
            <input 
                value={post.tag}
            ...
            <div className="flex-end mx-3 mb-5 gap-4">
                <Link href={'/'} className="text-blue-600 font-satoshi">  
                    Cancel
                </Link>
                <button 
                    type="submit"
